...
For more information on setting up your own BigBlueButton server or for using an external hosting provider visit [BigBlueButton Support](https://bigbluebutton.org/support "BigBlueButton Support").
